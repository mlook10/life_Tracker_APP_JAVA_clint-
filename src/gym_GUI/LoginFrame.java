...
public class LoginFrame extends javax.swing.JFrame {
    ...
    public LoginFrame() {
        ...
        try {
        BufferedImage bufferImg = ImageIO.read(new File("LoginCover.jpg"));

        Image target_img1 = bufferImg.getScaledInstance(jLabel1.getWidth(), jLabel1.getHeight(),Image.SCALE_SMOOTH);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String password=new String(jPasswordField1.getPassword());
             ...
             for (User user : users) {
                ...
                if( user.getUsername().equals(username) && user.getPassword().equals(password)){
                    ...
                    if(user instanceof Participant){
                        ...
                        ParticipantTasksFrame ptf=new ParticipantTasksFrame(p);
                        ptf.setVisible(true);
                       // break;
                    }
                    else{
                        CoachTasksFrame ctf=new CoachTasksFrame();
                        ctf.setVisible(true);
                        //break;
                    }
                }
             ...
             if(found==false)
                 JOptionPane.showMessageDialog(this, "Invalid username or password ..", "Invalid Credintials", JOptionPane.ERROR_MESSAGE);
